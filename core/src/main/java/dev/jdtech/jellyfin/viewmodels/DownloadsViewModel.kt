                    ...
                    episodesDownloaded
                        ...
                        .mapNotNull { (seriesId, episodes) ->
                            ...
                            JellyCastShow(
                                ...
                                overview =
                                    "${episodes.size} episodio${if (episodes.size != 1) "s" else ""} " +
                                        "descargado${if (episodes.size != 1) "s" else ""}",
                                sources = emptyList(),
                                seasons = emptyList(),
                    ...
                    val filteredSections =
                        if (newSelectedGenre == null) {
                            ...
                            CollectionSection(
                                ...
                                UiText.StringResource(R.string.movies_label),
                                currentState.items
                                    .filterIsInstance<JellyCastMovie>()
                            ...
                            CollectionSection(
                                ...
                                UiText.StringResource(R.string.shows_label),
                                currentState.items
                                    .filterIsInstance<JellyCastShow>()
                                    .filter { it.genres.contains(newSelectedGenre) },
                            ).let { if (it.items.isNotEmpty()) sections.add(it) }
