...
object DlnaHelper {
     ...
     */
    fun isDlnaDeviceAvailable(context: Context): Boolean = currentDevice != null && DlnaDeviceManager.isInitialized()
    ...
    fun loadMedia(
        ...
        try {
            ...
            val avTransportService =
                device.findService(UDAServiceType("AVTransport")) ?: run {
            ...
            val upnpService =
                DlnaDeviceManager.getUpnpService() ?: run {
                    Timber.e("UPnP service not available")
                    return false
                }

            // Set the media URI
            val setAVTransportCallback =
                object : SetAVTransportURI(
                    ...
                    override fun success(invocation: ActionInvocation<*>) {
                        ...
                        Handler(Looper.getMainLooper()).postDelayed({
                            ...
                            val playCallback =
                                object : Play(INSTANCE_ID, avTransportService) {
                                    override fun success(invocation: ActionInvocation<*>) {
        ...
        try {
            ...
            if (device != null) {
                ...
                if (avTransportService != null) {
                    ...
                    if (upnpService != null) {
                        val stopCallback =
                            object : Stop(INSTANCE_ID, avTransportService) {
                                override fun success(invocation: ActionInvocation<*>) {
    ...
    fun pause(context: Context) {
        try {
            ...
            val pauseCallback =
                object : Pause(INSTANCE_ID, avTransportService) {
                    override fun success(invocation: ActionInvocation<*>) {
    ...
    fun seek(
        ...
        try {
            ...
            val seekCallback =
                object : Seek(avTransportService, SeekMode.REL_TIME, target) {
                    override fun success(invocation: ActionInvocation<*>) {
    ...
    fun getCurrentPosition(
        ...
        try {
            ...
            val getPositionCallback =
                object : GetPositionInfo(INSTANCE_ID, avTransportService) {
     ...
     */
    fun getDuration(context: Context): Long = currentDuration
    ...
    fun setVolume(
        ...
        try {
            ...
            val renderingControlService =
                device.findService(UDAServiceType("RenderingControl")) ?: run {
            ...
            val setVolumeCallback =
                object : SetVolume(INSTANCE_ID, renderingControlService, volumeInt.toLong()) {
                    override fun success(invocation: ActionInvocation<*>) {
    ...
    fun getVolume(
        ...
        try {
            ...
            val getVolumeCallback =
                object : GetVolume(INSTANCE_ID, renderingControlService) {
                    override fun received(
                        invocation: ActionInvocation<*>,
                        currentVolume: Int,
                    ) {
     ...
     * Get media title
     */
    fun getMediaTitle(context: Context): String = currentMediaTitle

    /**
     * Get media subtitle
     */
    fun getMediaSubtitle(context: Context): String = currentMediaSubtitle

    /**
     * Get media image URL
     */
    fun getMediaImageUrl(context: Context): String? = currentMediaImageUrl
