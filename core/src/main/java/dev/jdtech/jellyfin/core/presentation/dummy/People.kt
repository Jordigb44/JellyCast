...
val dummyPersonDetail =
    JellyCastPerson(
        ...
        name = "Rosa Salazar",
        overview =
            "Rosa Bianca Salazar (/ˈsæləzɑːr/; born July 16, 1985) is an American actress. " +
                "She had roles in the NBC series Parenthood and the FX anthology series American Horror Story: Murder House. " +
                "She played the title character in the film Alita: Battle Angel. " +
                "She appeared in The Divergent Series: Insurgent, Maze Runner: The Scorch Trials and Maze Runner: The Death Cure " +
                "and also appeared in the Netflix films The Kindergarten Teacher and Bird Box. " +
                "Rosa Bianca Salazar was born on July 16, 1985. She is of Peruvian and French descent. " +
