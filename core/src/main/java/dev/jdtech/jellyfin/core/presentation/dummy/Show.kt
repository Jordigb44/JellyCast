...
val dummyShow =
    JellyCastShow(
        ...
        originalTitle = null,
        overview =
            "After his hometown is destroyed and his mother is killed, young Eren Yeager vows to " +
                "cleanse the earth of the giant humanoid Titans that have brought humanity to the brink of extinction.",
        sources = emptyList(),
        played = false,
        favorite = false,
        canPlay = true,
