...
class DownloadsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.downloadsRecyclerView.layoutManager =
    ...
    override fun onResume() {
        ...
        activity?.supportFragmentManager?.fragments?.let { fragments ->
            ...
            fragments.forEach { frag ->
                android.util.Log.d(
                    "DownloadsUI",
                    "  - ${frag.javaClass.simpleName}: isVisible=${frag.isVisible}, isHidden=${frag.isHidden}, isAdded=${frag.isAdded}",
                )
            }
        }
        ...
        binding.root.post {
            ...
            binding.root.post {
                android.util.Log.d(
                    "DownloadsUI",
                    "RecyclerView size after double post: ${binding.downloadsRecyclerView.width}x${binding.downloadsRecyclerView.height}",
                )
                android.util.Log.d(
                    "DownloadsUI",
                    "Root alpha: ${binding.root.alpha}, RecyclerView alpha: ${binding.downloadsRecyclerView.alpha}",
                )
                ...
                if (binding.downloadsRecyclerView.width < 500) {
                    ...
                    binding.downloadsRecyclerView.layoutParams =
                        binding.downloadsRecyclerView.layoutParams.apply {
