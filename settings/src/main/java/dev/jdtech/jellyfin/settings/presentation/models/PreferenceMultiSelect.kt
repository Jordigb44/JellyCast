...
data class PreferenceMultiSelect(
    ...
    val backendPreference: PreferenceBackend<Set<String>>,
    // Backend preference stores a Set<String>
    val options: Int,
    // Resource ID for the array of entry strings
    val optionValues: Int,
    // Resource ID for the array of entry values
    val value: Set<String> = emptySet(),
    // The current value is a Set of strings
) : Preference
